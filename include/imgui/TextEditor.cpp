...
const TextEditor::Palette& TextEditor::GetDarkImGuiPalette()
{
	const static TextEditor::Palette p = { {
		...
		0xFFE06C75, // Char literal (Red)
		0xFF61AFEF, // Punctuation (Blue)
		0xFF56B6C2, // Preprocessor (Cyan)
		0xFFE5C07B, // Identifier (Yellow)
		0xFFE5C07B, // Known identifier (Yellow)
		0xFF61AFEF, // Preproc identifier (Blue)
		0xFF5C6370, // Comment (single line) (Gray)
		0xFF5C6370, // Comment (multi line) (Gray)
		0xFF282C34, // Background (Dark gray)
		0xFFDCDCDC, // Cursor (Light gray)
		0x803E4451, // Selection (Dark blue with transparency)
		0x80E06C75, // ErrorMarker (Red with transparency)
		0x40D19A66, // Breakpoint (Orange with transparency)
		0xFF4B5263, // Line number (Medium gray)
		0x403E4451, // Current line fill (Dark blue with transparency)
		0x403E4451, // Current line fill (inactive) (Dark blue with transparency)
		0x405C6370, // Current line edge (Gray with transparency)
	} };
